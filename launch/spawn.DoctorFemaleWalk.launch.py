...
def generate_launch_description():
    ...
    xacro_sdf_model_path = os.path.join(models_path, 'DoctorFemaleWalk', 'model.sdf.xacro')

    # Launch configuration variables specific to simulation
    model_name = LaunchConfiguration('model_name', default='DoctorFemaleWalk')
    ...
    declare_model_name_cmd = DeclareLaunchArgument(
        name='model_name',
        default_value='DoctorFemaleWalk',
